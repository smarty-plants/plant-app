    ...
    return (
      ...
      >
        <TableHeader>
          ...
          <TableColumn key="Temperature" allowsSorting>Temperature (°C)</TableColumn>
          <TableColumn key="Humidity" allowsSorting>Humidity (%)</TableColumn>
          <TableColumn key="Light level" allowsSorting>Light level (%)</TableColumn>
          <TableColumn key="Mouisture of soil" allowsSorting>Mouisture of soil (%)</TableColumn>
        </TableHeader>
