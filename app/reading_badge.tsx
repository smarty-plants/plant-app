...
import { ArrowDownIcon, ArrowDownRightIcon, ArrowLongRightIcon, ArrowUpRightIcon, ArrowUpIcon } from '@heroicons/react/24/solid';
...
export default function ReadingBadge({status}: {status: StatusType}) {
    ...
    return (
        ...
        <Badge color={statusToColor[status]} icon={statusToIcon[status]}>{badgeText[status]}</Badge>
